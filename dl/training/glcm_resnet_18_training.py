...
# Hyperparameters
tensor_path   = "data/processed_tensors/GLCM/224x224_220_crop"
LR = 1e-4
WEIGHT_DECAY = 1e-2
EPOCHS = 20
TRAIN_BATCH_SIZE = 64
...
# W&B parameters
RUN_NAME = f"RESNET-18-220px-crop-{EPOCHS}ep"
RUN_DESCRIPTION = "In this run, i augmented the size of crop window to 220px with 10 margin"   
CONFIG = {
        "learning_rate": LR,
        "weight_decay": WEIGHT_DECAY,
        "architecture": "ResNet18",
        "dataset": "unique_220_crop_window_glcm_dataset",
        "epochs": EPOCHS,
...
dataset = pd.read_csv("data/processed_dataset/GLCM/unique_220_crop_window_glcm_radiomics_dataset_cleaned.csv")
...
loss_fig = plot_loss_curves(history, run_name=RUN_NAME)

wandb.log({
    "loss_curve": wandb.Image(loss_fig),
